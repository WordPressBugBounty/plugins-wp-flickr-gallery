...
function awl_flickr_gallery_shortcode($post_id)
{
	...
	if ($fg_gallery_title == 'true') {
		...
		<p class="awp-flickr-post-title"
			style="margin-right: 15px; margin-left: 10px; color:<?php echo esc_attr($fg_gallery_titlecolor); ?>; font-size: <?php echo esc_attr($fg_gallery_titlesize); ?>px ; text-align:<?php echo esc_attr($fg_gallery_titlealighment); ?>;">
